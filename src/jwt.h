...
#   dynlib libname
#   if defined(macosx)
#        define libname "libjwt.dylib"
#   else
#        define libname "libjwt.so"
#   endif
#endif
 ...
 *     performed.
 */
int jwt_decode(jwt_t **jwt, const char *token, const char *key,
	       int key_len);
 ...
 * @return Returns 0 on success, valid errno otherwise.
 */
int jwt_set_alg(jwt_t *jwt, jwt_alg_t alg, const char *key, int len);
